...
namespace EntidadesInstanciables
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            try 
            {
                Alumno a3 = new Alumno(3, "Jose", "Gutierrez", "12234456", EntidadesAbstractas.Persona.ENacionalidad.Argentino, Gimnasio.EClases.CrossFit, Alumno.EEstadoCuenta.MesPrueba);
                gim += a3;
            }
